...
@Component({
  ...
  templateUrl: './custom-dropzone-preview.html',
...
export class CustomDropzonePreviewComponent extends NgxDropzonePreviewComponent implements OnInit {
    ...
    if (this.file.type.indexOf("image") > -1) {
      ...
      switch (this.file.type){
        ...
        case "application/vnd.ms-excel":
          this.imageSrc = "/assets/icons/excel.png";
          break;

        case "application/msword":
        case "application/vnd.openxmlformats-officedocument.wordprocessingml.document":
          this.imageSrc = "/assets/icons/docx.png";
          break;

        case "application/pdf":
          this.imageSrc = "/assets/icons/pdf.png";
          break;

        //unknown file type, show generic image
        default: 
          this.imageSrc = "/assets/icons/file.png";
      }
    }
  ...
  //Image file, preview the base 64 image
